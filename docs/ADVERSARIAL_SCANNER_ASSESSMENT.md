...
- **Adversarial Catalog**: [`rules/adversarial_scanner_catalog.json`](rules/adversarial_scanner_catalog.json) (15 verified scenarios)
- **Catalog Schema**: [`rules/schemas/adversarial_scanner_catalog.schema.json`](rules/schemas/adversarial_scanner_catalog.schema.json)
...
- **Release Gate**: Integrated into Gate 3 of [`scripts/release_gate.py`](scripts/release_gate.py).
